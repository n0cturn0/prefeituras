                                                        ...
                                                        {col.items && (
                                                            <ul className="space-y-2">
                                                                {col.items.map((subItem, subIndex) => (
                                                                    <li key={subIndex}>
                                                                        <a href={subItem.link} className={`block hover:text-blue-600 hover:translate-x-1 transition-transform flex items-center ${subItem.bold ? 'font-bold text-blue-800' : 'text-blue-600'}`}>
                                        ...
                                        <div className="absolute left-0 w-64 top-full bg-white text-gray-800 shadow-xl border-t border-gray-100 py-2 animate-fade-in z-50 rounded-b-lg">
                                            <ul className="flex flex-col">
                                                {item.items.map((subItem, subIndex) => (
                                                    <li key={subIndex}>
                                                        <a href={subItem.link} className="block px-6 py-3 hover:bg-blue-50 text-blue-600 hover:text-blue-800 border-b border-gray-50 last:border-0 transition flex items-center">
