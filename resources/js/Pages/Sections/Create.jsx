...
export default function Create({ auth, departments, managerDepartment, is_admin }) {
    const { data, setData, post, processing, errors } = useForm({
        name: '',
        status: true,
        department_id: is_admin ? '' : (managerDepartment?.id || ''),
    });
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-slate-800 leading-tight">Nova Seção</h2>}
        >
            <Head title="Nova Seção" />
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        {is_admin ? (
                            ...
                            <div>
                                ...
                                <TextInput
                                    value={managerDepartment?.name || 'Seu Departamento'}
