    ...
    const menuGroups = [
        ...
        },
        {
            ...
            items: [
                {
                    name: 'PPA',
                    href: route('ppa.index'),
                    icon: FileText,
                    active: url.startsWith('/transparencia/ppa'),
                    roles: ['Admin', 'Gestor']
                },
                {
                    name: 'Programas PPA',
                    ...
                    icon: Layers,
                    active: url.startsWith('/transparencia/programas'),
                    roles: ['Admin', 'Gestor']
                },
                {
                    name: 'LDO',
                    href: route('ldo.index'),
                    icon: Scale,
                    active: url.startsWith('/transparencia/ldo'),
                    roles: ['Admin', 'Gestor']
                },
                {
                    name: 'LOA',
                    href: route('loa.index'),
                    icon: Wallet,
                    active: url.startsWith('/transparencia/loa'),
                    roles: ['Admin', 'Gestor']
                }
            ]
        },
